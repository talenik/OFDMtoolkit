...
sim.minErr	= 100 ;				%TODO minimum nr. of errors for each Eb/N0 point, set 10000 for reliable results:
...
%sim.ECC		= true ;
%sim.EbN0	= [[ 0 : 1 : 6 ] 6.1] ;		%good values if ECC enabled
%sim.EbN0	= [ 4 : 1 : 6 ] ;	
...
for x = 1 : length( sim.EbN0 )
	...
	while nErr < sim.minErr && nFrames < sim.maxFrames
